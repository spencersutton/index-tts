...
# 1. 情感与音色参考音频相同
data = IndexTTS2RequestData(text="还是会想你，还是想登你", spk_audio_path="assets/jay_promptvn.wav")
...
data = IndexTTS2RequestData(
    text="还是会想你，还是想登你", spk_audio_path="assets/jay_promptvn.wav", emo_control_method=2, emo_vec=emo_vec
)
...
# 4. 使用情感描述文本控制
data = IndexTTS2RequestData(
    text="还是会想你，还是想登你", spk_audio_path="assets/jay_promptvn.wav", emo_control_method=3, emo_text="极度悲伤"
)
