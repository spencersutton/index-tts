...
class MaskGCT_S2A(nn.Module):
    def __init__(
        ...
        self.diff_estimator = DiffLlama(hidden_size=hidden_size, num_heads=self.num_heads, num_layers=num_layers)
    ...
    def forward(self, x0, x_mask, cond_code=None):
        ...
        logits, mask_layer, final_mask, x0, prompt_len, mask_prob = self.compute_loss(x0, x_mask, cond)
        return logits, mask_layer, final_mask, x0, prompt_len, mask_prob
