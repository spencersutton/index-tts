...
@overload
def adaptive_max_pool1d(input: Tensor, output_size: _int | _size, return_indices: Literal[False] = False) -> Tensor: ...
@overload
...
@overload
def adaptive_max_pool2d(input: Tensor, output_size: _int | _size, return_indices: Literal[False] = False) -> Tensor: ...
@overload
...
@overload
def adaptive_max_pool3d(input: Tensor, output_size: _int | _size, return_indices: Literal[False] = False) -> Tensor: ...
@overload
