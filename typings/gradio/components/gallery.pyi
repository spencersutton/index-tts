...
class Gallery(Component):
    ...
    def __init__(
        self,
        value: (Sequence[np.ndarray | PIL.Image.Image | str | Path | tuple] | Callable | None) = ...,
        *,
        format: str = ...,
    ...
    def postprocess(self, value: list[GalleryMediaType | CaptionedGalleryMediaType] | None) -> GalleryData: ...
    @staticmethod
