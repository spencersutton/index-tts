...
class Image(StreamingInput, Component):
    ...
    def __init__(
        ...
        *,
        ...
        image_mode: (Literal["1", "L", "P", "RGB", "RGBA", "CMYK", "YCbCr", "LAB", "HSV", "I", "F"] | None) = ...,
        sources: (
            list[Literal["upload", "webcam", "clipboard"]] | Literal["upload", "webcam", "clipboard"] | None
        ) = ...,
        type: Literal["numpy", "pil", "filepath"] = ...,
    ...
    def preprocess(self, payload: ImageData | None) -> np.ndarray | PIL.Image.Image | str | None: ...
    def postprocess(
