...
class Label(Component):
    ...
    def preprocess(self, payload: LabelData | None) -> dict[str, float] | str | int | float | None: ...
    def postprocess(self, value: dict[str | float, float] | str | float | None) -> LabelData | dict | None: ...
