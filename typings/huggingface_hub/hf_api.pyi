...
class HfApi:
    ...
    def get_token_permission(self, token: bool | str | None = ...) -> Literal["read", "write", "fineGrained", None]:
        """
    ...
    @validate_hf_hub_args
    def set_space_sleep_time(self, repo_id: str, sleep_time: int, *, token: bool | str | None = ...) -> SpaceRuntime:
