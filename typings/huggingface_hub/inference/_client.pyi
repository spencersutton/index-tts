...
class InferenceClient:
    ...
    def audio_to_audio(self, audio: ContentT, *, model: str | None = ...) -> list[AudioToAudioOutputElement]: ...
    ...
    def image_to_text(self, image: ContentT, *, model: str | None = ...) -> ImageToTextOutput: ...
    ...
    def tabular_classification(self, table: dict[str, Any], *, model: str | None = ...) -> list[str]: ...
    def tabular_regression(self, table: dict[str, Any], *, model: str | None = ...) -> list[float]: ...
    ...
    def get_endpoint_info(self, *, model: str | None = ...) -> dict[str, Any]: ...
    def health_check(self, model: str | None = ...) -> bool: ...
    @property
