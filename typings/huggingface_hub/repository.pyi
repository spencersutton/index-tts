...
class Repository:
    ...
    @_deprecate_method(
        version="1.0",
        message="Please prefer the http-based alternatives instead. Given its large adoption in legacy code, the complete"
    ...
    def git_push(
        self, upstream: Optional[str] = ..., blocking: bool = ..., auto_lfs_prune: bool = ...
