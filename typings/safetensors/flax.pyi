...
def save(tensors: Dict[str, Array], metadata: Optional[Dict[str, str]] = ...) -> bytes:
    """
...
def save_file(
    tensors: Dict[str, Array], filename: Union[str, os.PathLike], metadata: Optional[Dict[str, str]] = ...
) -> None:
    """
    Saves a dictionary of tensors into raw bytes in safetensors format.
