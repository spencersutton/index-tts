...
def save(tensor_dict: Dict[str, np.ndarray], metadata: Optional[Dict[str, str]] = ...) -> bytes:
    """
...
def save_file(
    tensor_dict: Dict[str, np.ndarray], filename: Union[str, os.PathLike], metadata: Optional[Dict[str, str]] = ...
) -> None:
    """
    Saves a dictionary of tensors into raw bytes in safetensors format.
