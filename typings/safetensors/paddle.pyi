...
def save(tensors: Dict[str, paddle.Tensor], metadata: Optional[Dict[str, str]] = ...) -> bytes:
    """
...
def save_file(
    tensors: Dict[str, paddle.Tensor], filename: Union[str, os.PathLike], metadata: Optional[Dict[str, str]] = ...
) -> None:
    """
    Saves a dictionary of tensors into raw bytes in safetensors format.
...
def load_file(filename: Union[str, os.PathLike], device=...) -> Dict[str, paddle.Tensor]:
    """
