...
def save_model(
    model: torch.nn.Module, filename: str, metadata: Optional[Dict[str, str]] = ..., force_contiguous: bool = ...
):
    """
...
def load_model(
    model: torch.nn.Module, filename: Union[str, os.PathLike], strict: bool = ..., device: Union[str, int] = ...
...
def save(tensors: Dict[str, torch.Tensor], metadata: Optional[Dict[str, str]] = ...) -> bytes:
    """
...
def save_file(
    tensors: Dict[str, torch.Tensor], filename: Union[str, os.PathLike], metadata: Optional[Dict[str, str]] = ...
):
    """
    Saves a dictionary of tensors into raw bytes in safetensors format.
...
def load_file(filename: Union[str, os.PathLike], device: Union[str, int] = ...) -> Dict[str, torch.Tensor]:
    """
