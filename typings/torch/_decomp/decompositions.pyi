...
def safe_softmax(self, dim, dtype=...): ...
@register_decomposition(aten.smooth_l1_loss)
@out_wrapper()
@pw_cast_for_opmath
def smooth_l1_loss(self: Tensor, target: Tensor, reduction: int = ..., beta: float = ...): ...
...
@out_wrapper()
def dist(input: Tensor, other: Tensor, p: float = ...): ...
...
def slice_forward(self: Tensor, dim: int = ..., start: int | None = ..., end: int | None = ..., step: int = ...): ...
...
@out_wrapper()
def max_unpool2d(self: TensorLike, indices: TensorLike, output_size: list[int]): ...
...
def index_add_(x: TensorLike, dim: int, index: TensorLike, tensor: TensorLike, *, alpha: NumberType = ...): ...
...
def pad_sequence(sequences, batch_first=..., padding_value=...): ...
...
@out_wrapper()
def uniform(x: Tensor, low: bool | float = ..., high: bool | float = ..., generator: torch.Generator | None = ...): ...
...
def one_layer_rnn_data(inp, hidden, params, has_biases, hidden_fn, batch_sizes, reverse=...): ...
def rnn_cell(nonlinearity): ...
def rnn_cell_data(nonlinearity): ...
def one_layer_rnn(inp, hidden, params, has_biases, hidden_fn, reverse=...): ...
def mkldnn_one_layer_lstm(inp, hidden, params, has_biases, reverse=...): ...
...
@out_wrapper()
def binary_cross_entropy_with_logits(self, target, weight=..., pos_weight=..., reduction=...): ...
...
def upsample_bicubic2d_vec(
    a: Tensor, output_size: tuple[int, int] | None, align_corners: bool, scale_factors: tuple[float, float] | None = ...
) -> Tensor: ...
@register_decomposition(aten.aminmax)
@out_wrapper("min", "max")
def aminmax(self, *, dim=..., keepdim=...): ...
@register_decomposition(aten.nansum)
@out_wrapper()
def nansum(self, dim=..., keepdim=..., *, dtype=...): ...
...
@out_wrapper(exact_dtype=True)
@pw_cast_for_opmath
def baddbmm(self, batch1, batch2, beta=..., alpha=...): ...
...
def squeeze_default(self: Tensor, dim: int | None = ...): ...
@register_decomposition(aten.isin)
@out_wrapper()
def isin(elements, test_elements, *, assume_unique=..., invert=...): ...
@register_decomposition(aten.bernoulli.default)
def bernoulli(self: torch.Tensor, *, generator: torch.Generator | None = ...) -> torch.Tensor: ...
def isin_default(elements, test_elements, *, invert=...): ...
...
def resize_as(self, other, memory_format=...): ...
