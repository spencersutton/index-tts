...
from typing import Any, Callable, Optional, Protocol, Union, TypeAlias
...
CompilerFn: TypeAlias = Callable[[fx.GraphModule, list[torch.Tensor]], CompiledFn]
_BACKENDS: dict[str, Optional[EntryPoint]] = ...
_COMPILER_FNS: dict[str, CompilerFn] = ...

def register_backend(
    compiler_fn: Optional[CompilerFn] = ..., name: Optional[str] = ..., tags: Sequence[str] = ...
) -> Callable[..., Any]: ...
