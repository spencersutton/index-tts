...
def create_instruction(
    name: str, *, arg: Optional[int] = ..., argval: Optional[Any] = ..., target: Optional[Instruction] = ...
) -> Instruction: ...
...
def linetable_311_writer(first_lineno: int) -> tuple[list[int], Callable[[Optional[dis.Positions], int], None]]: ...
...
def fix_vars(
    ...
    varname_from_oparg: Optional[Callable[..., Any]] = ...,
) -> None: ...
...
def transform_code_object(
    code: types.CodeType,
    transformations: Callable[[list[Instruction], dict[str, Any]], Optional[DynamoTracerOutput]],
    safe: bool = ...,
...
def bytecode_from_template(
    fn: Callable[..., Any], varname_map: Optional[Mapping[Any, Any]] = ..., noreturn: bool = ..., noprefix: bool = ...
) -> list[Instruction]: ...
