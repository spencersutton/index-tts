...
class PyCodegen:
    def __init__(
        ...
        tempvars: Optional[dict[Union[VariableTracker, Source], Any]] = ...,
        overridden_sources: Optional[dict[Source, Source]] = ...,
    ) -> None: ...
    ...
    def __call__(self, value: Union[VariableTracker, Source], allow_cache: bool = ...) -> None: ...
