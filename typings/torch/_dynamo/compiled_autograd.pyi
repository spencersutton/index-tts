...
class AutogradCompilerInstance:
    ...
    def bind_function(
        self, fn_name: str, fn: Callable[..., Any], is_custom_function: bool, is_traceable: bool
    ) -> str: ...
    ...
    def bind_objects_to_proxies(
        self, objects: Sequence[Any], proxies: Any, origins: Optional[list[tuple[int, str]]] = ...
    ) -> Sequence[Any]: ...
    def bind_backward_state(self, index: int) -> BackwardState: ...
    def set_node_origin(
        self, node_name: str, nodecall_index: int, pyobj: Optional[torch.autograd.Function]
    ) -> None: ...
