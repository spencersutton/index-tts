...
from typing import Any, Callable, Optional, TYPE_CHECKING, TypeVar, Union, overload, TypeAlias
...
class set_stance(_DecoratorContextManager):
    ...
    def __init__(
        ...
        *,
        ...
        force_backend: Union[str, Callable[..., Any], None] = ...,
    ) -> None: ...
...
@forbid_in_graph
def mark_unbacked(
    t: Any, index: Union[int, list[Any], tuple[Any]], strict: bool = ..., specialize_on: Optional[list[Any]] = ...
) -> None: ...
@forbid_in_graph
def mark_dynamic(
    t: Any,
    ...
    *,
    ...
    min: Optional[int] = ...,
    max: Optional[int] = ...,
    specialize_on: Optional[list[Any]] = ...,
) -> None: ...
@forbid_in_graph
...
def patch_dynamo_config(
    arg1: Optional[Union[str, dict[str, Any], tuple[tuple[str, Any], ...]]] = ..., arg2: Any = ..., **kwargs: Any
