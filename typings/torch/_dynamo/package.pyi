...
class CompilePackage:
    def __init__(
        ...
        dynamo: Optional[_DynamoCacheEntry] = ...,
        ignore_inlined_sources: bool = ...,
    ) -> None: ...
    def is_initialized(self) -> bool: ...
    def initialize(
        self, fn: Any, dynamo: Optional[_DynamoCacheEntry] = ..., ignore_inlined_sources: bool = ...
    ) -> None: ...
    @property
    ...
    def add_resume_function(
        self, python_code: types.CodeType, python_module: str, function_name: Optional[str]
    ) -> None: ...
...
_Backends: TypeAlias = dict[_BackendId, PrecompileCacheArtifact[Any]]
...
class DiskDynamoCache(DiskDynamoStore):
    ...
    def load(self, fn: Callable[..., Any]) -> Optional[tuple[_DynamoCacheEntry, dict[_BackendId, Any]]]: ...
