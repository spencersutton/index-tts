...
@overload
def attrgetter(attr1: str, attr2: str, /, *attrs: str) -> Callable[[Any], tuple[_U1, _U2, *_Us]]: ...
@substitute_in_graph(operator.attrgetter, is_embedded_type=True)
def attrgetter(*attrs: str) -> Callable[[Any], Any | tuple[Any, ...]]: ...
@overload
def itemgetter[T](item: _T, /) -> Callable[[Any], _U]: ...
@overload
def itemgetter[T1, T2, *Ts](item1: _T1, item2: _T2, /, *items: *_Ts) -> Callable[[Any], tuple[_U1, _U2, *_Us]]: ...
