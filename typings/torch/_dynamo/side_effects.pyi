...
class SideEffects:
    ...
    def __init__(
        ...
        id_to_variable: dict[int, VariableTracker] | None = ...,
        store_attr_mutations: dict[VariableTracker, dict[str, VariableTracker]] | None = ...,
        keepalive: list[Any] | None = ...,
        save_for_backward: list[tuple[AutogradFunctionContextVariable, list[VariableTracker]]] | None = ...,
        tensor_hooks: dict[
            int, tuple[variables.TensorVariable, VariableTracker, variables.RemovableHandleVariable, str]
        ]
        | None = ...,
    ) -> None: ...
