...
def tabulate(
    rows: Union[list[tuple[str, Any]], list[list[Any]]], headers: Union[tuple[str, ...], list[str]]
) -> str: ...
...
class CompileEventLogger:
    ...
    def log_instant_event(
        event_name: str, metadata: dict[str, Any], time_ns: Optional[int] = ..., log_level: CompileEventLogLevel = ...
    ) -> None: ...
    @staticmethod
    def add_data(
...
def dynamo_timed(
    ...
    dynamo_compile_column_us: Optional[str] = ...,
    compile_id: Optional[CompileId] = ...,
    is_backward: Optional[bool] = ...,
    log_waitcounter: bool = ...,
    waitcounter_name_override: Optional[str] = ...,
...
class ChromiumEventLogger:
    ...
    def log_instant_event(
        self, event_name: str, time_ns: int, metadata: Optional[dict[str, Any]] = ..., log_pt2_compile_event: bool = ...
    ) -> None: ...
...
def tensor_always_has_static_shape(
    tensor: Union[torch.Tensor, Any], is_tensor: bool, tensor_source: Source
