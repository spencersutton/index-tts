...
from typing import Any, Callable, Optional, Union, final, TypeAlias
...
class GraphModuleDeserializer(metaclass=Final):
    ...
    def deserialize(
        ...
        example_inputs: Optional[Union[tuple[tuple[torch.Tensor, ...], dict[str, Any]], bytes]] = ...,
        symbol_name_to_range: Optional[dict[str, symbolic_shapes.ValueRanges]] = ...,
    ) -> Result: ...
...
def serialize(
    exported_program: ep.ExportedProgram, opset_version: Optional[dict[str, int]] = ..., pickle_protocol: int = ...
) -> SerializedArtifact: ...
def deserialize(
