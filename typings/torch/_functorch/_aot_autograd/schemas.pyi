...
from typing import Any, Callable, NewType, Optional, Protocol, TYPE_CHECKING, TypeVar, Union, TypeAlias
...
class SubclassCreationMeta:
    ...
    memory_format: Optional[MemoryFormatMeta] = ...
    def compute_outer_size_and_stride(self, all_args, *, curr_start_idx: int):  # -> tuple[PyTree | Any, PyTree | Any]:
        ...
...
FxValue: TypeAlias = Union[Tensor, int, SymInt, BackwardState]
