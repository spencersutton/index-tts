...
def reduction_combine(
    reduction_type, var, next_value, helper_val=..., index: Optional[sympy.Symbol] = ..., src_dtype=...
):  # -> str:
    ...
...
@functools.lru_cache
def stride_at_vec_range(index: sympy.Expr, var: sympy.Symbol, vec_length: Optional[int] = ...): ...
...
class CppKernel(Kernel):
    ...
    def codegen_conditions(
        self, code: BracesBuffer, prefix: Optional[str] = ..., var: Optional[sympy.Symbol] = ...
    ):  # -> bool:
        ...
...
class CppVecKernel(CppKernel):
    ...
    def reduction_combine_vec(
        ...
        next_value,
        helper_val=...,
        index: Optional[sympy.Symbol] = ...,
        horizontal_reduction: Optional[bool] = ...,
        src_dtype: Optional[torch.dtype] = ...,
    ):  # -> str:
        ...
