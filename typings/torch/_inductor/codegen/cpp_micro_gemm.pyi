...
class CppMicroGemmConfig:
    """CppMicroGemmConfig(input_dtype: torch.dtype, input2_dtype: torch.dtype, output_dtype: torch.dtype, compute_dtype: torch.dtype, vec_isa_cls: type[torch._inductor.cpu_vec_isa.VecISA], register_blocking: torch._inductor.codegen.cpp_utils.GemmBlocking, extra_check: Optional[Callable[..., bool]] = None)"""
