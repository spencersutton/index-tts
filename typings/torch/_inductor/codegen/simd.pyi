...
class SIMDKernel(Kernel[CSEVariableType], Generic[CSEVariableType]):
    ...
    def __init__(
        ...
        pid_cache: Optional[dict[str, str]] = ...,
        override_persistent_reduction: Optional[bool] = ...,
        override_cooperative_reduction: Optional[bool] = ...,
        tiling_scores: Optional[dict[str, sympy.Expr]] = ...,
    ) -> None: ...
    @property
    @cache_on_self
    @no_type_check
    ...
    def mask_loads(self, mask: Union[str, OpsWrapper], value: float) -> Iterator[str]: ...
...
class SIMDScheduling(BaseScheduling):
    ...
    def can_use_32bit_indexing(
        numel: sympy.Expr, buffers: Iterable[Union[ir.Buffer, ir.TensorBox, ir.TorchBindObject, ir.IRNode]]
    ) -> bool: ...
    ...
    @classmethod
    def select_tiling(
        cls, node_schedule, numel, reduction_numel=..., coalesce_analysis: Optional[CoalesceVarAnalysis] = ...
    ) -> dict[str, sympy.Expr]: ...
    @classmethod
    ...
    def generate_kernel_code_from_nodes(
        self, nodes, benchmark_kernel=..., hint_override: Optional[int] = ...
    ):  # -> str | Any:
        ...
