...
BufferLike: TypeAlias = Union[ir.Buffer, WorkspaceArg]
...
TritonGrid: TypeAlias = Union[tuple[Union[int, sympy.Expr], ...], Callable[[TritonMetaParams], tuple[int, ...]]]

def user_defined_kernel_grid_fn_code(
    name: str,
    configs: list[triton.Config],
    grids: list[TritonGrid],
    wrapper: Optional[PythonWrapperCodegen] = ...,
    original_fxnode_name: Optional[str] = ...,
) -> tuple[str, str]: ...
...
BufferName = str
Line: TypeAlias = Union[MemoryPlanningLine, LineContext]
...
class PythonWrapperCodegen(CodeGen):
    ...
    def define_user_defined_triton_kernel(
        self, kernel, configs, kwargs, restore_value_args, reset_to_zero_args, grids: list[list[Union[int, sympy.Expr]]]
    ...
    def codegen_unbacked_symbol_defs_for_outputs(
        self, output_name: str, outputs: Any, unbacked_bindings: Optional[dict[sympy.Symbol, pytree.KeyPath]]
    ) -> None: ...
