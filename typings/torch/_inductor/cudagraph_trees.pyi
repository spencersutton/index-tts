...
from typing import Any, Callable, Optional, TYPE_CHECKING, TypeVar, Union, TypeAlias
...
def dynamo_timed_cudagraph(
    name: str, compile_id: Optional[CompileId], mode: Optional[CompilationMode]
...
class StorageWeakRefWrapper:
    ...
    def __init__(
        self, inp: Union[Tensor, UntypedStorage], extra_ref_check: Optional[Callable[[], bool]] = ...
    ) -> None: ...
    @classmethod
    def from_weakref_and_data_ptr(
        cls: type[StorageWeakRefWrapper], cdata: Any, data_ptr: int, extra_ref_check: Optional[Callable[[], bool]] = ...
...
StackTraces: TypeAlias = list[Optional[str]]
...
class CUDAGraphNode:
    ...
    def prepare_alias_info_for_tensor_construction(
        self, out_alias_info: Optional[OutputAliasInfo], metadata: Union[dict[str, Any], int, None]
