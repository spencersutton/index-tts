...
from typing import Any, Callable, IO, Optional, Union, TypeAlias
...
def create_mapping_pre_post_grad_nodes(
    pre_grad_graph_id: Optional[int], post_to_pre_grad_nodes_json: dict[str, Any]
...
def set_kernel_post_grad_provenance_tracing(
    node_schedule: Union[Sequence[BaseSchedulerNode], ExternKernel], kernel_name: str, is_extern: bool = ...
) -> Optional[int]: ...
