...
class _RecordLoadStoreInner(V.MockHandler):
    ...
    def drop_unused_symbols(
        index: Union[int, sympy.Expr], var_names: list[sympy.Expr], sizes: list[sympy.Expr]
    ) -> None: ...
    def canonicalize(
...
class FreeSymbolsOpsHandler(DefaultHandler):
    ...
    def indirect_indexing(
        self, index_var: Any, size: Union[int, sympy.Expr], check: bool = ..., wrap_neg: bool = ...
    ) -> sympy.Symbol: ...
...
def extract_free_symbols(
    ...
    rindex: Optional[Sequence[sympy.Expr]] = ...,
    unbacked_only: bool = ...,
