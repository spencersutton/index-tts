...
from typing import Any, Callable, Optional, Protocol, TYPE_CHECKING, TypeVar, Union, TypeAlias
...
DTypeArg: TypeAlias = Union[DTypeVar, torch.types.Number, str, OpsValue]

@functools.cache
def get_promoted_dtype(
    *args: Sequence[tuple[torch.dtype, bool]], type_promotion_kind: Optional[ELEMENTWISE_TYPE_PROMOTION_KIND] = ...
): ...
...
class DtypePropagationOpsHandler:
    ...
    @staticmethod
    def to_dtype(
        x: DTypeArg, dtype: torch.dtype, src_dtype: Optional[torch.dtype] = ..., use_compute_types=...
    ) -> torch.dtype: ...
    @staticmethod
