...
def should_pad_common(mat1: Tensor, mat2: Tensor, input: Tensor | None = ...) -> bool: ...
...
def addmm_replace(
    input: Tensor | None, mat1: Tensor, mat2: Tensor, beta: float = ..., alpha: float = ...
) -> Tensor: ...
