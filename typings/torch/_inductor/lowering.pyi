...
def make_foreach_pointwise(pw_fn, allow_alpha=...):  # -> Callable[..., list[None]]:
    ...
def to_dtype(
    x: Union[TensorBox, ShapeAsConstantBuffer], dtype: torch.dtype, copy: bool = ...
...
def upsample_nearestnd(
    x, output_size, scales_x: tuple[Optional[float], ...], n: int = ..., exact: bool = ...
):  # -> TensorBox | ShapeAsConstantBuffer:
    ...
@register_lowering(aten.upsample_nearest1d.default)
def upsample_nearest1d(x, output_size, scales: Optional[float] = ...):  # -> TensorBox | ShapeAsConstantBuffer:
    ...
@register_lowering(aten.upsample_nearest2d.default)
def upsample_nearest2d(
    x, output_size, scales_h: Optional[float] = ..., scales_w: Optional[float] = ...
):  # -> TensorBox | ShapeAsConstantBuffer:
    ...
@register_lowering(aten.upsample_nearest3d.default)
def upsample_nearest3d(
    x, output_size, scales_d: Optional[float] = ..., scales_h: Optional[float] = ..., scales_w: Optional[float] = ...
):  # -> TensorBox | ShapeAsConstantBuffer:
    ...
