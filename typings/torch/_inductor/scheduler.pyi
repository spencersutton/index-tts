...
def init_group_node(
    group_snode: Union[FusedSchedulerNode, GroupedSchedulerNode], scheduler: Scheduler, snodes: list[BaseSchedulerNode]
) -> None: ...
...
class ForeachKernelSchedulerNode(FusedSchedulerNode):
    ...
    def __init__(
        ...
        prev_node_1: Optional[BaseSchedulerNode] = ...,
        prev_node_2: Optional[BaseSchedulerNode] = ...,
...
class Scheduler:
    ...
    def generate_kernel_code_from_nodes(
        self, nodes: Sequence[BaseSchedulerNode], benchmark_kernel: bool, hint_override: Optional[int] = ...
    ) -> str: ...
    ...
    def decide_fusion_fail_reason(
        self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, common_buf_names: Union[tuple[str], OrderedSet[str]]
    ) -> str: ...
    ...
    def get_graph_partition_symbol_inputs(
        self, partition: PartitionType, input_nodes: dict[str, Union[ir.IRNode, ir.TorchBindObject, sympy.Expr]]
