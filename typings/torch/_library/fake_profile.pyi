...
class TensorMetadata:
    """TensorMetadata(rank: int, dtype: torch.dtype, device: torch.device, layout: torch.layout)"""
...
@dataclass(frozen=True)
class OpProfile:
    """OpProfile(args_profile: tuple[typing.Optional[torch._library.fake_profile.TensorMetadata]], out_profile: Union[torch._library.fake_profile.TensorMetadata, tuple[torch._library.fake_profile.TensorMetadata]])"""
