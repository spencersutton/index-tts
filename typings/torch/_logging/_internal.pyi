...
@dataclass
class LogRegistry:
    """LogRegistry(log_alias_to_log_qnames: dict[str, list[str]] = <factory>, artifact_log_qnames: set[str] = <factory>, child_log_qnames: set[str] = <factory>, artifact_names: set[str] = <factory>, visible_artifacts: set[str] = <factory>, artifact_descriptions: dict[str, str] = <factory>, off_by_default_artifact_names: set[str] = <factory>, artifact_log_formatters: dict[str, logging.Formatter] = <factory>)"""
...
@dataclass
class LogState:
    """LogState(log_qname_to_level: dict[str, str] = <factory>, artifact_names: set[str] = <factory>)"""
