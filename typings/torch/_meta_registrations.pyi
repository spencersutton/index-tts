...
def meta_randperm(n, *, generator=..., out): ...
@register_meta(aten.randperm.default)
def meta_randperm_default(n, *, dtype=..., layout=..., device=..., pin_memory=...): ...
@register_meta([aten.randint.default, aten.randint.out])
@out_wrapper()
def meta_randint(high, size, *, dtype=..., layout=..., device=..., pin_memory=...): ...
@register_meta([aten.randint.low, aten.randint.low_out])
@out_wrapper()
def meta_randint_low(low, high, size, *, dtype=..., layout=..., device=..., pin_memory=...): ...
@register_meta([aten.rand.default, aten.rand.out])
@out_wrapper()
def meta_rand_default(size, *, dtype=..., layout=..., device=..., pin_memory=...): ...
...
def meta_sparse_structured_mm(mat1: Tensor, mat1_meta: Tensor, mat2: Tensor, out_dtype: torch.dtype | None = ...): ...
...
def make_dep_token(*, dtype=..., layout=..., device=..., pin_memory=..., memory_format=...): ...
...
def sym_constrain_range_for_size(size, min=..., max=...): ...
...
def checkFloatingOrComplex(t: Tensor, f_name: str, allow_low_precision_dtypes: bool = ...): ...
def checkIsMatrix(A: Tensor, f_name: str, arg_name: str = ...): ...
def checkInputsSolver(A: Tensor, B: Tensor, left: bool, f_name: str): ...
def checkSameDevice(fn_name: str, result: Tensor, input: Tensor, result_name: str = ...): ...
def checkUplo(UPLO: str): ...
@register_meta([aten._linalg_eigh.default, aten._linalg_eigh.eigenvalues])
@out_wrapper("eigenvalues", "eigenvectors")
def meta__linalg_eigh(A: Tensor, UPLO: str = ..., compute_v: bool = ...): ...
...
def linalg_cholesky_ex(A: Tensor, upper: bool = ..., check_errors: bool = ...): ...
...
def linalg_inv_ex_meta(A: Tensor, check_errors: bool = ...): ...
...
@out_wrapper()
def meta_bernoulli(self, *, generator=...): ...
@register_meta(aten.bernoulli_.float)
def meta_bernoulli_(self, p=..., generator=...): ...
@register_meta(aten.bernoulli.p)
def meta_bernoulli_p(self, p=..., generator=...): ...
@register_meta([aten.poisson.default, aten.poisson.out])
@out_wrapper()
def meta_poisson(self, generator=...): ...
...
if torch._C._has_mkldnn:
    ...
    def meta_quantized_max_pool2d(input, kernel_size, stride=..., padding=..., dilation=..., ceil_mode=...): ...
...
@out_wrapper("values", "indices")
def meta_median_mode_dim(input, dim=..., keepdim=...): ...
...
@out_wrapper()
def meta_rrelu_with_noise(self, noise, lower=..., upper=..., training=..., generator=...): ...
@register_meta([aten.rrelu_with_noise_functional])
def meta_rrelu_with_noise_functional(self, noise, lower=..., upper=..., training=..., generator=...): ...
...
def meta_index_put(self, indices, values, accumulate=...): ...
...
def meta_max_pool2d_with_indices(input, kernel_size, stride=..., padding=..., dilation=..., ceil_mode=...): ...
...
@out_wrapper("out", "indices")
def meta_max_pool3d_with_indices(input, kernel_size, stride=..., padding=..., dilation=..., ceil_mode=...): ...
...
def zeros_like(self, dtype=..., layout=..., device=..., pin_memory=..., memory_format=...): ...
@register_meta([aten.ones.default, aten.ones.out])
@out_wrapper()
def meta_ones(size, *, dtype=..., layout=..., device=..., pin_memory=..., requires_grad=...): ...
@register_meta([aten.zeros.default, aten.zeros.out])
@out_wrapper()
def meta_zeros(size, *, dtype=..., layout=..., device=..., pin_memory=..., requires_grad=...): ...
@register_meta(aten.select_scatter.default)
def meta_select_scatter(self, src, dim, index): ...
@register_meta(aten.slice_scatter.default)
def meta_slice_scatter(self, src, dim=..., start=..., end=..., step=...): ...
...
def get_operator_enum(reduce_, use_new_options=...): ...
def scatter_gather_dtype_check(method_name, self, index, src_opt=...): ...
def ensure_nonempty_dim(dim): ...
def scatter_shape_check(self, dim, index, src_opt=...): ...
def scatter_meta_impl(self, dim, index, src=..., reduce_=..., use_new_options=...): ...
...
@out_wrapper()
def meta_multinomial(input, num_samples, replacement=..., *, generator=...): ...
...
def meta_sort(self, stable=..., dim=..., descending=..., values=..., indices=...): ...
...
def scalar_tensor(s, dtype=..., layout=..., device=..., pin_memory=...): ...
@register_meta(aten.topk.default)
def topk_meta(self, k, dim=..., largest=..., sorted=...): ...
@register_meta(aten._segment_reduce_backward)
@out_wrapper()
def meta__segment_reduce_backward(grad, output, data, reduce, lengths=..., offsets=..., axis=..., initial=...): ...
@register_meta([aten.kthvalue.default, aten.kthvalue.values])
@out_wrapper("values", "indices")
def kthvalue_meta(self, k, dim=..., keepdim=...): ...
...
@out_wrapper()
def meta_bucketize(self, boundaries, *, out_int32=..., right=...): ...
@register_meta([aten.histc])
@out_wrapper()
def meta_histc(input, bins=..., min=..., max=...): ...
...
@out_wrapper()
def meta_searchsorted(sorted_sequence, self, *, out_int32=..., right=..., side=..., sorter=...): ...
...
@out_wrapper()
def meta_isin(elements, test_elements, *, assume_unique=..., invert=...): ...
