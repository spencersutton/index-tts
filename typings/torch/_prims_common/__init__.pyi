...
type NumberTypeType = type[bool | int | float | complex]
...
def check_contiguous_sizes_strides(sizes, strides, false_if_dde=...):
    """
...
def canonicalize_dims(rank, indices, wrap_scalar=...): ...
...
def check_fp_or_complex(dtype: torch.dtype, fn_name: str, allow_low_precision_dtypes: bool = ...):
    """
...
def check_is_matrix(A: TensorLikeType, f_name: str, arg_name: str = ...): ...
...
def get_higher_dtype(
    a: torch.dtype | TensorLikeType | NumberType | None, b: torch.dtype | TensorLikeType | NumberType | None
) -> torch.dtype | None:
    """
...
class CUDARngStateHelper:
    @staticmethod
    def get_torch_state_as_tuple(fake_mode: AbstractContextManager[Any] = ...): ...
    @staticmethod
