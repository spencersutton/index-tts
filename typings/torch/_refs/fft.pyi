...
@out_wrapper()
def fft(input: TensorLikeType, n: int | None = ..., dim: int = ..., norm: NormType = ...) -> TensorLikeType: ...
@register_decomposition(aten.fft_ifft)
@out_wrapper()
def ifft(input: TensorLikeType, n: int | None = ..., dim: int = ..., norm: NormType = ...) -> TensorLikeType: ...
@register_decomposition(aten.fft_rfft)
@out_wrapper()
def rfft(input: TensorLikeType, n: int | None = ..., dim: int = ..., norm: NormType = ...) -> TensorLikeType: ...
@register_decomposition(aten.fft_irfft)
@out_wrapper()
def irfft(input: TensorLikeType, n: int | None = ..., dim: int = ..., norm: NormType = ...) -> TensorLikeType: ...
@register_decomposition(aten.fft_hfft)
@out_wrapper()
def hfft(input: TensorLikeType, n: int | None = ..., dim: int = ..., norm: NormType = ...) -> TensorLikeType: ...
...
@out_wrapper()
def fftn(
    input: TensorLikeType, s: ShapeType | None = ..., dim: DimsType | None = ..., norm: NormType = ...
) -> TensorLikeType: ...
...
def fftshift(input: TensorLikeType, dim: DimsType | None = ...) -> TensorLikeType: ...
@register_decomposition(aten.fft_ifftshift)
def ifftshift(input: TensorLikeType, dim: DimsType | None = ...) -> TensorLikeType: ...
