...
pytree = ...
__all__ = ["get_fast_op_impls", "has_meta", "op_implementations_checks", "stride_incorrect_op"]
...
def unique2(fake_mode, func, arg, sorted=..., return_inverse=..., return_counts=...): ...
@register_op_impl(aten.select.int)
def meta_select(fake_mode, func, self, dim, index): ...
@register_op_impl(aten.unique_dim.default)
def unique_dim(fake_mode, func, arg, dim, sorted=..., return_inverse=..., return_counts=...): ...
@register_op_impl(aten.unique_consecutive.default)
def _(fake_mode, func, arg, return_inverse=..., return_counts=..., dim=...): ...
...
def infer_size(a, b): ...
def make_fast_binary_impl(slow_ref, type_promotion_kind=...): ...
def fast_detach(fake_mode, x, include_real=...): ...
@functools.cache
