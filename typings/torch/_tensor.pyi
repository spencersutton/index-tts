...
class Tensor(torch._C.TensorBase):
    ...
    def __rtruediv__(self, other: Tensor | bool | complex) -> Tensor: ...
    def __itruediv__(self, other: Tensor | bool | complex) -> Tensor: ...
    def __pow__(self, other: Tensor | Number | complex) -> Tensor: ...
    def __ipow__(self, other: Tensor | Number | complex) -> Tensor: ...
