...
def memory_allocated(device_index: _device_t = ..., /) -> int:
    """
    Return the current :ref:`accelerator<accelerators>` device memory occupied by tensors
...
def max_memory_allocated(device_index: _device_t = ..., /) -> int:
    """
    Return the current :ref:`accelerator<accelerators>` maximum device memory occupied by tensors
    in bytes for a given device index.
...
def memory_reserved(device_index: _device_t = ..., /) -> int:
    """
    Return the current :ref:`accelerator<accelerators>` device memory managed by the caching allocator
    in bytes for a given device index.
...
def max_memory_reserved(device_index: _device_t = ..., /) -> int:
    """
    Return the current :ref:`accelerator<accelerators>` maximum device memory managed by the caching allocator
    in bytes for a given device index.
...
def reset_accumulated_memory_stats(device_index: _device_t = ..., /) -> None:
    """
    Reset the "accumulated" (historical) stats tracked by the current :ref:`accelerator<accelerators>`
...
def reset_peak_memory_stats(device_index: _device_t = ..., /) -> None:
    """
    Reset the "peak" stats tracked by the current :ref:`accelerator<accelerators>`
    memory allocator for a given device index.
