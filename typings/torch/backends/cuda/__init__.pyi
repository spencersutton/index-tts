...
def preferred_linalg_library(backend: None | str | torch._C._LinalgBackend = ...) -> torch._C._LinalgBackend:
    """
...
def preferred_blas_library(backend: None | str | torch._C._BlasBackend = ...) -> torch._C._BlasBackend:
    """
...
def preferred_rocm_fa_library(backend: None | str | torch._C._ROCmFABackend = ...) -> torch._C._ROCmFABackend:
    """
    [ROCm-only]
...
def sdp_kernel(
    enable_flash: bool = ..., enable_math: bool = ..., enable_mem_efficient: bool = ..., enable_cudnn: bool = ...
