...
class LocalStateDictConfig(StateDictConfig):
    """LocalStateDictConfig(offload_to_cpu: bool = False)"""
...
class LocalOptimStateDictConfig(OptimStateDictConfig):
    """LocalOptimStateDictConfig(offload_to_cpu: bool = False)"""
...
class StateDictSettings:
    """StateDictSettings(state_dict_type: torch.distributed.fsdp.api.StateDictType, state_dict_config: torch.distributed.fsdp.api.StateDictConfig, optim_state_dict_config: torch.distributed.fsdp.api.OptimStateDictConfig)"""
