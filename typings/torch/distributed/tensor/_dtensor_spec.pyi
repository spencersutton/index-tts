...
@dataclass
class DTensorSpec:
    """DTensorSpec(mesh: torch.distributed.device_mesh.DeviceMesh, placements: tuple[torch.distributed.tensor.placement_types.Placement, ...], tensor_meta: Optional[torch.distributed.tensor._dtensor_spec.TensorMeta] = None)"""
