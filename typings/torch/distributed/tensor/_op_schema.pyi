...
PlacementList: TypeAlias = list[Optional[Placement]]
OutputSpecType: TypeAlias = Optional[Union[DTensorSpec, Sequence[Optional[DTensorSpec]]]]
...
class OpSchema:
    ...
    _comparison_key: Optional[tuple[object, ...]] = ...
    @property
