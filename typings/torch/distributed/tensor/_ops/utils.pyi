...
def register_prop_rule(
    op: Union[torch._ops.OpOverload, list[torch._ops.OpOverload]], schema_info: Optional[RuntimeSchemaInfo] = ...
...
def expand_to_full_mesh_op_strategy(
    ...
    *,
    input_index: int = ...,
    inplace_op: bool = ...,
    is_valid_strategy_cb: Optional[Callable[[list[DTensorSpec], tuple[Optional[DTensorSpec], ...]], bool]] = ...,
) -> OpStrategy: ...
