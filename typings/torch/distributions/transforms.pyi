...
class ExpTransform(Transform):
    r"""Transform via the mapping :math:`y = \exp(x)`."""
...
class PowerTransform(Transform):
    r"""Transform via the mapping :math:`y = x^{\text{exponent}}`."""
...
class SigmoidTransform(Transform):
    r"""Transform via the mapping :math:`y = \frac{1}{1 + \exp(-x)}` and :math:`x = \text{logit}(y)`."""
