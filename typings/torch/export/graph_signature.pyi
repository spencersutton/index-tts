...
class TensorArgument:
    """TensorArgument(name: str)"""

    name: str

@dataclasses.dataclass
class TokenArgument:
    """TokenArgument(name: str)"""

    name: str

@dataclasses.dataclass
class SymIntArgument:
    """SymIntArgument(name: str)"""

    name: str

@dataclasses.dataclass
class SymFloatArgument:
    """SymFloatArgument(name: str)"""

    name: str

@dataclasses.dataclass
class SymBoolArgument:
    """SymBoolArgument(name: str)"""

    name: str

@dataclasses.dataclass
class CustomObjArgument:
    """CustomObjArgument(name: str, class_fqn: str, fake_val: Optional[torch._library.fake_class_registry.FakeScriptObject] = None)"""
...
class ConstantArgument:
    """ConstantArgument(name: str, value: Union[int, float, bool, str, NoneType])"""
...
@dataclasses.dataclass
class InputSpec:
    """InputSpec(kind: torch.export.graph_signature.InputKind, arg: Union[torch.export.graph_signature.TensorArgument, torch.export.graph_signature.SymIntArgument, torch.export.graph_signature.SymFloatArgument, torch.export.graph_signature.SymBoolArgument, torch.export.graph_signature.ConstantArgument, torch.export.graph_signature.CustomObjArgument, torch.export.graph_signature.TokenArgument], target: Optional[str], persistent: Optional[bool] = None)"""
...
@dataclasses.dataclass
class OutputSpec:
    """OutputSpec(kind: torch.export.graph_signature.OutputKind, arg: Union[torch.export.graph_signature.TensorArgument, torch.export.graph_signature.SymIntArgument, torch.export.graph_signature.SymFloatArgument, torch.export.graph_signature.SymBoolArgument, torch.export.graph_signature.ConstantArgument, torch.export.graph_signature.CustomObjArgument, torch.export.graph_signature.TokenArgument], target: Optional[str])"""
...
class ExportBackwardSignature:
    """ExportBackwardSignature(gradients_to_parameters: dict[str, str], gradients_to_user_inputs: dict[str, str], loss_output: str)"""
