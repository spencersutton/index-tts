...
class Tracer(TracerBase):
    ...
    def getattr(self, attr: str, attr_val: Any, parameter_proxy_cache: dict[str, Any]):
        ...
        """
    @compatibility(is_backward_compatible=False)
    def create_args_for_root(self, root_fn, is_module, concrete_args=...):
        """
        ...
        """
    @compatibility(is_backward_compatible=True)
    def trace(self, root: torch.nn.Module | Callable[..., Any], concrete_args: dict[str, Any] | None = ...) -> Graph:
        """
...
class _PatchedFn(NamedTuple):
    """_PatchedFn(frame_dict, fn_name, orig_fn, new_fn)"""
...
class _Patcher:
    ...
    def patch(self, frame_dict: dict[str, Any], name: str, new_fn: Callable, deduplicate: bool = ...):
        """Replace frame_dict[name] with new_fn until we exit the context manager."""
    def patch_method(self, cls: type, name: str, new_fn: Callable, deduplicate: bool = ...):
