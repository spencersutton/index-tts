...
class _PyTreeCodeGen(CodeGen):
    ...
    def gen_fn_def(self, free_vars, maybe_return_annotation, *, expanded_def: bool = ...): ...
    def generate_output(self, output_args, *, descs: Any | None = ...): ...
...
class _FindNodesLookupTable:
    ...
    def find_nodes(self, *, op: str, target: Target | None = ...): ...
...
class Graph:
    ...
    def output_node(self) -> Node:
        ...
        """
    @compatibility(is_backward_compatible=False)
    def find_nodes(self, *, op: str, target: Target | None = ..., sort: bool = ...):
        """
    ...
    def erase_node(self, to_erase: Node) -> None:
        ...
        """
    @compatibility(is_backward_compatible=True)
    def inserting_before(self, n: Node | None = ...):
        """
        ...
        """
    @compatibility(is_backward_compatible=True)
    def inserting_after(self, n: Node | None = ...):
        """
        Set the point at which create_node and companion methods will insert into the graph.
        When used within a 'with' statement, this will temporary set the insert point and
        then restore it when the with statement exits::
    ...
    def node_copy(self, node: Node, arg_transform: Callable[[Node], Argument] = ...) -> Node:
        ...
        """
    @compatibility(is_backward_compatible=True)
    def output(self, result: Argument, type_expr: Any | None = ...):
        """
