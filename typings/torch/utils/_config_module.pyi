...
class _Config(Generic[T]):
    ...
    def __init__(
        ...
        default: Union[T, object] = ...,
        justknob: Optional[str] = ...,
        env_name_default: Optional[Union[str, list[str]]] = ...,
        env_name_force: Optional[Union[str, list[str]]] = ...,
...
class ConfigModule(ModuleType):
    ...
    def patch(
        self, arg1: Optional[Union[str, dict[str, Any]]] = ..., arg2: Any = ..., **kwargs: dict[str, Any]
    ) -> ContextDecorator: ...
