...
def vr_is_bool[T: (sympy.Expr, SympyBoolean)](vr: ValueRanges[_T]) -> TypeGuard[ValueRanges[SympyBoolean]]: ...
def vr_is_expr[T: (sympy.Expr, SympyBoolean)](vr: ValueRanges[_T]) -> TypeGuard[ValueRanges[sympy.Expr]]: ...
...
class SymPyValueRangeAnalysis:
    ...
    @staticmethod
    def to_dtype(a, dtype, src_dtype=...): ...
    @staticmethod
