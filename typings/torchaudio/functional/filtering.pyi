...
def band_biquad(
    waveform: Tensor, sample_rate: int, central_freq: float, Q: float = ..., noise: bool = ...
) -> Tensor: ...
def bandpass_biquad(
...
def bass_biquad(
    waveform: Tensor, sample_rate: int, gain: float, central_freq: float = ..., Q: float = ...
) -> Tensor: ...
...
def lfilter(
    waveform: Tensor, a_coeffs: Tensor, b_coeffs: Tensor, clamp: bool = ..., batching: bool = ...
) -> Tensor: ...
