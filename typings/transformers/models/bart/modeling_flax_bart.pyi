...
class FlaxBartForSequenceClassificationModule(nn.Module):
    ...
    def __call__(
        ...
        return_dict: bool = ...,
        deterministic: bool = ...,
    ):  # -> tuple[Any, *tuple[Any | tuple[Any | None, ...] | tuple[()], ...]] | Any | FlaxSeq2SeqSequenceClassifierOutput:
        ...
...
class FlaxBartForQuestionAnsweringModule(nn.Module):
    ...
    def __call__(
        ...
        return_dict: bool = ...,
        deterministic: bool = ...,
    ):  # -> tuple[Any, Any, *tuple[Any | tuple[Any | None, ...] | tuple[()], ...]] | Any | FlaxSeq2SeqQuestionAnsweringModelOutput:
        ...
...
class FlaxBartForCausalLMModule(nn.Module):
    ...
    def __call__(
        ...
        return_dict: bool = ...,
        deterministic: bool = ...,
    ):  # -> tuple[Any, *tuple[Any | tuple[Any | None, ...] | tuple[()], ...]] | Any | FlaxCausalLMOutputWithCrossAttentions:
        ...
