...
class JukeboxDecoder(nn.Module):
    ...
    def forward(self, hidden_states, all_levels=...): ...
...
class JukeboxBottleneckBlock(nn.Module):
    ...
    def forward(self, hidden_states, update_codebook=...): ...

class JukeboxBottleneck(nn.Module):
    def __init__(self, config, levels) -> None: ...
    def encode(self, raw_audio): ...
    def decode(self, music_tokens, start_level=..., end_level=...): ...
    def forward(self, input_audio): ...

JUKEBOX_START_DOCSTRING = ...

@add_start_docstrings(..., JUKEBOX_START_DOCSTRING)
class JukeboxVQVAE(PreTrainedModel):
    ...
    def encode(self, input_audio, start_level=..., end_level=..., bs_chunks=...): ...
...
class JukeboxAttention(nn.Module):
    ...
    def factored_qkv(self, hidden_states, last_encoder_hidden_states=..., sample=...): ...
    def prime_qkv(self, hidden_states, last_encoder_hidden_states=..., sample=...): ...
    def decode_qkv(self, hidden_states, last_encoder_hidden_states=..., sample=...): ...
...
class JukeboxMusicTokenConditioner(nn.Module):
    ...
    def forward(self, music_tokens, raw_audio_conditioning=...): ...
...
class JukeboxPrior(PreTrainedModel):
    ...
    def get_metadata(self, labels, start, total_length, offset, get_indices=...): ...
    ...
    def get_encoder_states(self, lyric_tokens, sample=...): ...
...
class JukeboxModel(JukeboxPreTrainedModel):
    ...
    @add_start_docstrings(..., JUKEBOX_SAMPLING_INPUT_DOCSTRING)
