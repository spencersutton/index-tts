...
class DetrImageProcessorFast(BaseImageProcessorFast):
    ...
    def post_process_segmentation(self, outputs, target_sizes, threshold=..., mask_threshold=...): ...
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes: Optional[list[tuple[int, int]]] = ...): ...
