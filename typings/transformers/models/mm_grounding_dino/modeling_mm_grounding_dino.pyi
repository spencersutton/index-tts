...
class MMGroundingDinoMultiscaleDeformableAttention(nn.Module):
    def __init__(self, config: MMGroundingDinoConfig, num_heads: int, n_points: int) -> None: ...
...
class MMGroundingDinoEncoder(MMGroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        return_dict=...,
    ):  # -> tuple[Tensor | tuple[Tensor, ...] | Any | tuple[()] | tuple[Tensor | None, ...] | tuple[tuple[()] | tuple[Any, ...] | None, tuple[()] | tuple[Any, ...] | None, tuple[()] | tuple[Any, ...] | None, tuple[()] | tuple[Any, ...] | None], ...] | MMGroundingDinoEncoderOutput:
...
class MMGroundingDinoDecoder(MMGroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states=...,
        return_dict=...,
    ):  # -> tuple[Any | Tensor | tuple[Any, ...] | tuple[()] | tuple[tuple[()] | tuple[Any, ...] | None, ...], ...] | MMGroundingDinoDecoderOutput:
...
def build_position_encoding(
    config,
):  # -> MMGroundingDinoSinePositionEmbedding | MMGroundingDinoLearnedPositionEmbedding:
    ...
...
class MMGroundingDinoModel(MMGroundingDinoPreTrainedModel):
    def __init__(self, config: MMGroundingDinoConfig) -> None: ...
    def get_encoder(self):  # -> MMGroundingDinoEncoder:
        ...
    def get_decoder(self):  # -> MMGroundingDinoDecoder:
        ...
...
class MMGroundingDinoForObjectDetection(MMGroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs: MMGroundingDinoEncoderOutput | tuple | None = ...,
        output_attentions: bool | None = ...,
        output_hidden_states: bool | None = ...,
        return_dict: bool | None = ...,
        labels: list[dict[str, torch.LongTensor | torch.FloatTensor]] | None = ...,
    ):  # -> tuple[Any | int | Tensor | dict[str, Any] | LongTensor, ...] | MMGroundingDinoObjectDetectionOutput:
