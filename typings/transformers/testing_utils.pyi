...
def require_triton(min_version: str = ...): ...
...
def run_command(command: list[str], return_stdout=...): ...
...
def is_flaky(max_attempts: int = ..., wait_before_retry: Optional[float] = ..., description: Optional[str] = ...): ...
def hub_retry(max_attempts: int = ..., wait_before_retry: Optional[float] = ...): ...
...
@require_torch
def cleanup(device: str, gc_collect=...): ...

DeviceProperties: TypeAlias = tuple[Optional[str], Optional[int], Optional[int]]
PackedDeviceProperties: TypeAlias = tuple[Optional[str], Union[None, int, tuple[int, int]]]
...
def torchrun(script: str, nproc_per_node: int, is_torchrun: bool = ..., env: Optional[dict] = ...): ...
