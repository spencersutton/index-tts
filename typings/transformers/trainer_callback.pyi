...
class TrainerState:
    ...
    trial_name: str | None = ...
    trial_params: dict[str, str | float | int | bool] = ...
...
class TrainerCallback:
    ...
    def on_predict(
        self, args: TrainingArguments, state: TrainerState, control: TrainerControl, metrics, **kwargs
    ):  # -> None:
        """
...
class EarlyStoppingCallback(TrainerCallback, ExportableState):
    ...
    """
    def __init__(self, early_stopping_patience: int = ..., early_stopping_threshold: float | None = ...) -> None: ...
