...
def postprocess(text: str, full_to_half: bool = ..., remove_interjections: bool = ..., remove_puncts: bool = ..., tag_oov: bool = ...) -> str:
    """
...
def verbalize(text: str, lang: Literal["en", "zh", "ja"], operator: Literal["tn", "itn"], remove_erhua: bool = ...) -> str:
    """
    Verbalize the text.
...
def normalize(text: str, config: Optional[NormalizerConfig] = ..., **kwargs): # -> str:
    """
    Normalize the text.
