...
class Attend(Module):
    def __init__(self, *, dropout=..., causal=..., heads=..., pre_talking_heads=..., post_talking_heads=..., pre_scale_post_talking_heads=..., sparse_topk=..., sparse_topk_straight_through=..., scale=..., qk_norm=..., l2_distance=..., sigmoid=..., gumbel_softmax=..., gumbel_softmax_temp=..., gumbel_softmax_hard=..., cog_signed=..., custom_attn_fn: Callable | None = ..., flash=..., softclamp_logits=..., logit_softclamp_value=..., add_zero_kv=..., head_learned_sink=..., selective=..., hard=..., cope=..., onnxable=..., sdp_kwargs: dict = ...) -> None:
        ...
