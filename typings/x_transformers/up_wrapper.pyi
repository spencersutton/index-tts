...
class UniversalPretrainWrapper(Module):
    def __init__(self, model: TransformerWrapper, data_generator: SyntheticDataGenerator | Module | None = ..., buffer_size=..., num_reset=..., batch_size=..., seq_len=..., seed_length=..., reset_turing_machine_every=..., keep_buffer_on_cpu=...) -> None:
        ...
