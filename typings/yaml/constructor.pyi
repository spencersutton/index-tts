...
class FullConstructor(SafeConstructor):
    ...
    def find_python_module(self, name: str, mark, unsafe: bool = ...): ...
    def find_python_name(self, name: str, mark, unsafe: bool = ...): ...
    def construct_python_name(self, suffix, node): ...
    def construct_python_module(self, suffix, node): ...
    def make_python_instance(self, suffix, node, args=..., kwds=..., newobj: bool = ..., unsafe: bool = ...): ...
    def set_python_instance_state(self, instance: Any, state, unsafe: bool = ...) -> None: ...
...
class UnsafeConstructor(FullConstructor):
    ...
    def make_python_instance(self, suffix: str, node, args=..., kwds=..., newobj: bool = ...): ...
